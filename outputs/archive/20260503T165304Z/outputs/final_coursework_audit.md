...
Created: 2026-05-03T16:51:36.553483+00:00
...
| distilbert-base-uncased | transformer_encoder | 0.9544062486712525 | results/transformer/classification_reports/distilbert_base_uncased_report.json; results/transformer/confusion_matrices/distilbert_base_uncased_confusion_matrix.png |
...
| bert-base-uncased | transformer_encoder | Runnable configuration pending; no completed evidence found. |
| nlpaueb/legal-bert-base-uncased | transformer_encoder | Runnable configuration pending; no completed evidence found. |
| nlpaueb/bert-base-uncased-contracts | transformer_encoder | Runnable configuration pending; no completed evidence found. |
| roberta-base | transformer_encoder | Runnable configuration pending; no completed evidence found. |
| microsoft/deberta-v3-base | transformer_encoder | Runnable configuration pending; no completed evidence found. |
